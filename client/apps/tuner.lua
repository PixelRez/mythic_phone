...
function ModifyBoost(plate, value)
    if value == 0 then
        SetVehicleHandlingFloat(
            ...
            "CHandlingData",
            "fInitialDriveForce",
            TunedVehs[plate].default.fInitialDriveForce
        )
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
            "fLowSpeedTractionLossMult",
            TunedVehs[plate].default.fLowSpeedTractionLossMult
        )
    else
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
            "fInitialDriveForce",
            TunedVehs[plate].default.fInitialDriveForce + (TunedVehs[plate].default.fInitialDriveForce * (value / 100))
        )
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
            "fLowSpeedTractionLossMult",
            TunedVehs[plate].default.fLowSpeedTractionLossMult +
                (TunedVehs[plate].default.fLowSpeedTractionLossMult * (value / 10))
        )
    end
end
...
function ModifySuspension(plate, value)
    if value == 5 then
        ...
        SetVehicleHandlingFloat(
            ...
            "CHandlingData",
            "fSuspensionCompDamp",
            TunedVehs[plate].default.fSuspensionCompDamp
        )
    else
...
function ModifyTransmission(plate, value)
    ...
    if tonumber(value) == 5 then
        SetVehicleHandlingFloat(
            ...
            TunedVehs[plate].default.fClutchChangeRateScaleUpShift
        )
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
            "fClutchChangeRateScaleDownShift",
            TunedVehs[plate].default.fClutchChangeRateScaleDownShift
        )
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
            "fInitialDragCoeff",
            TunedVehs[plate].default.fInitialDragCoeff
        )
    elseif tonumber(value) < 5 then
        if
            TunedVehs[plate].default.fClutchChangeRateScaleUpShift > 5 and
                TunedVehs[plate].default.fClutchChangeRateScaleUpShift - (tonumber(value) + 5) > 1.0
         then
            SetVehicleHandlingFloat(
                currentVehicle,
                "CHandlingData",
                "fClutchChangeRateScaleUpShift",
                TunedVehs[plate].default.fClutchChangeRateScaleUpShift - (tonumber(value) + 5)
            )
        else
        ...
        if
            TunedVehs[plate].default.fClutchChangeRateScaleDownShift > 5 and
                TunedVehs[plate].default.fClutchChangeRateScaleDownShift - (tonumber(value) + 5) > 1.0
         then
            SetVehicleHandlingFloat(
                currentVehicle,
                "CHandlingData",
                "fClutchChangeRateScaleDownShift",
                TunedVehs[plate].default.fClutchChangeRateScaleDownShift - (tonumber(value) + 5)
            )
        else
        ...
        SetVehicleHandlingFloat(
            ...
            "CHandlingData",
            "fInitialDragCoeff",
            TunedVehs[plate].default.fInitialDragCoeff + (tonumber(value) / 10)
        )
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
            "fDriveInertia",
            TunedVehs[plate].default.fDriveInertia + (tonumber(value) / 10)
        )
    else
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
            "fClutchChangeRateScaleUpShift",
            TunedVehs[plate].default.fClutchChangeRateScaleUpShift + tonumber(value)
        )
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
            "fClutchChangeRateScaleDownShift",
            TunedVehs[plate].default.fClutchChangeRateScaleDownShift + tonumber(value)
        )
        SetVehicleHandlingFloat(
            currentVehicle,
            "CHandlingData",
...
function ModifyBrakes(plate, value)
    if value == 5 then
        SetVehicleHandlingFloat(
            ...
            "CHandlingData",
            "fBrakeBiasFront",
            TunedVehs[plate].default.fBrakeBiasFront
        )
    else
        if value == 0 then
            value = 1
...
function ModifyDriveTrain(plate, value)
    if value == 5 then
        SetVehicleHandlingFloat(
            ...
            "CHandlingData",
            "fDriveBiasFront",
            TunedVehs[plate].default.fDriveBiasFront
        )
    else
        if value == 0 then
            value = 1
    ...
    if TunedVehs[plate] == nil then
        TunedVehs[plate] = {
            default = {
                ...
                fClutchChangeRateScaleUpShift = GetVehicleHandlingFloat(
                    veh,
                    "CHandlingData",
                    "fClutchChangeRateScaleUpShift"
                ),
                fClutchChangeRateScaleDownShift = GetVehicleHandlingFloat(
                    veh,
                    "CHandlingData",
                    "fClutchChangeRateScaleDownShift"
                ),
...
AddEventHandler(
    "mythic_veh:client:EnteredVehicle",
    function(currVeh, currSeat, name)
