...
$("#screen-content").on(
  "submit",
  "[data-section=keypad] #call-number",
  event => {
    event.preventDefault();
    let data = $(event.currentTarget).serializeArray();
    console.log("Submitted from keypad");
...
$("#screen-content").on(
  "click",
  "[data-section=history] .call-actions .call-action-call",
  event => {
...
$("#screen-content").on(
  "click",
  "[data-section=history] .call-actions .call-action-text",
  event => {
    let data = $(event.currentTarget)
      .parent()
      .parent()
...
$("#screen-content").on(
  "click",
  "[data-section=history] .call-actions .call-action-delete",
  event => {
    let data = $(event.currentTarget)
      .parent()
      .parent()
...
$("#screen-content").on(
  "keyup",
  "[data-section=contacts] .contact-search input",
  event => {
    event.preventDefault();
...
$("#screen-content").on(
  "click",
  "[data-section=contacts] .phone-contact",
  event => {
    if (
      $(event.currentTarget)
        .find(".call-actions")
...
$("#screen-content").on(
  "click",
  "[data-section=contacts] .call-actions .call-action-call",
  event => {
    let data = $(event.currentTarget)
      .parent()
      .parent()
...
$("#screen-content").on(
  "click",
  "[data-section=contacts] .call-actions .call-action-text",
  event => {
    let data = $(event.currentTarget)
      .parent()
      .parent()
