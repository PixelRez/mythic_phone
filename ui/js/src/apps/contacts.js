...
$("#screen-content").on("submit", "#contacts-add-contact", event => {
  event.preventDefault();
  console.log("Clicked from contacts add contact");
...
$("#screen-content").on(
  "click",
  ".contacts-list .contact-actions .action-call",
  event => {
...
$("#screen-content").on(
  "click",
  ".contacts-list .contact-actions .action-text",
  event => {
    let data = $(event.currentTarget)
      .parent()
      .parent()
...
$("#screen-content").on(
  "click",
  ".contacts-list .contact-actions .action-edit",
  event => {
    let data = $(event.currentTarget)
      .parent()
      .parent()
...
$("#screen-content").on(
  "click",
  ".contacts-list .contact-actions .action-delete",
  event => {
